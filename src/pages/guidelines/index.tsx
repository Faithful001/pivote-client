  ...
  const instructions = [
    {
      ...
      desc: 'All registered and verified students/users are eligible to participate in active voting processes.',
      icon: FiInfo,
    },
    {
  ...
  return (
    <div className="space-y-8 max-w-4xl">
      <div>
        ...
        <p className="text-slate-500 text-sm">Please read and understand the system guidelines before casting your vote.</p>
      </div>
      ...
      <div className="bg-white border border-slate-200/60 rounded-2xl p-8 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {instructions.map((item, index) => (
            <div key={index} className="border border-slate-100 rounded-2xl p-6 space-y-3 bg-slate-50/50">
