...
export default function Layout({ children }: LayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex">
      ...
      {/* Always mounted (instead of `isSidebarOpen && ...`) so the
          enter/exit transitions actually have something to animate.
          Conditionally mounting/unmounting skips transitions entirely
          since the element is just gone on the next render. */}
      <div
